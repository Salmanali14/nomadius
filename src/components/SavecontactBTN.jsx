...
const SavecontactBTN = ({ singlelink, handlelink,handlebtn,btn,links,linkdata,linkTitle,setLinkTitle }) => {
...
<div onClick={() => handleLinkMediaModalop({  linkId: linkdata?.id, title: linkTitle,placeholder:linkdata?.placeholder,id:date,color:color.text ,bgcolor:color.background}, currentUser, links)} className="w-[100%] h-[52px]  mt-8 bg-[#37e6a6] rounded-xl flex justify-center items-center font-[600] text-[1.1em] text-white cursor-pointer relative">
Confirm
</div>
 <br></br>
