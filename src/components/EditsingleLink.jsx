...
const EditsingleLink = ({returnIcons, handlesingleEdit,setsingleEdit,singleEdit ,linkdata,value1,setLinkTitle,linkTitle,setvalue1,links,bggcolor}) => {
...
<img src={returnIcons(linkdata?.linkId)} className="w-[80px] mt-5 mb-5"/>
...
<div><img className="w-[45px]  ml-1" src={returnIcons(linkdata?.linkId)}/></div>
...
<div onClick={() => handleLinkMediaUpdate({ name: linkdata.name, linkId: linkdata.linkId, title: linkTitle,placeholder:linkdata.placeholder,image:linkdata.image,value:value1,id:linkdata?.id }, currentUser, links)} className="w-[100%] h-[52px]  mt-8 bg-[#37e6a6] rounded-xl flex justify-center items-center font-[600] text-[1.1em] text-white cursor-pointer relative">
Update
</div>
 <br></br>
